define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        randomWord:['擁有200磅未來肌肉', '興趣:洗碗', '一大舊腹肌', '擅長用腳趾撩鼻','坐過的船都沉了','着鞋唔着袜', '用手指刷牙',
            '世界因为我而陆沉', '省港澳雀王', '瘦過張柏芝', '爛GAG王', '有梦想的人', '吃薯片多個吃齋', '比猩猩還誠實', '老人精',
            '大細路', '社交無能', '以為自己最有型', '講遍天下無敵手', '隱者般的存在感', '生意能手', '講到做到', '兩斜插刀',
            '在宇宙盡頭也找不到的好人', '24小時扮忙', '自怕狂', 'Uno draw 4 聖手', '輕輕跳兩下就可以產生地震', '']
    }
